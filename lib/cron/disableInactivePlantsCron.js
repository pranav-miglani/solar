...
function startDisableInactivePlantsCron() {
  ...
  cronJob = cron.schedule(cronSchedule, async () => {
    try {
      ...
      console.log(`🕐 Disable inactive plants cron triggered at ${hour}:${minute.toString().padStart(2, '0')} IST (daily at 2 AM IST)`)
  ...
  console.log('✅ Disable inactive plants cron job initialized - running daily at 2 AM IST (20:30 UTC)')
}
